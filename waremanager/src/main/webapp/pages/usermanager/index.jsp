 ...
 <link rel="apple-touch-icon-precomposed" href="../assets/ico/apple-touch-icon-57-precomposed.png"> -->
  ...
  <div class="navbar">
     <div class="navbar-inner">
             ...
             <a class="brand" href="index.html"><span class="first">中国水电顾问集团</span>  <span class="second">风电张北有限公司</span> </a>
             <a class="brand"href="index.jsp" class="brand" align="center"><span class="first"> <img src="${pageContext.request.contextPath}/images/logo.png"></span><span class="second"><!-- <img src="images/1.png">  --></span></a>
     </div>
 </div> 
    <div class="sidebar-nav">
        <a href="#dashboard-menu" class="nav-header" data-toggle="collapse"><i class="icon-hand-right"></i>warehouse</a>
        ...
        <a href="#error-menu" class="nav-header collapsed" data-toggle="collapse"><i class="icon-hand-right"></i>系统管理<i class="icon-chevron-up"></i></a>
        <ul id="error-menu" class="nav nav-list collapse">
            <li ><a href="403.html">添加用户</a></li>
            <li ><a href="404.html">用户列表</a></li>
            <li ><a href="500.html">修改信息</a></li>
        </ul>
